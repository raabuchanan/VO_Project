...
% plot(keypoints1(2, :), keypoints1(1, :), 'go', 'Linewidth', 2);
% 
% figure(3);
% for i = 1:16
%     subplot(4, 4, i);
...
% hold on;
% plot(keypoint_matches1(1,:),keypoint_matches1(2,:),'bx','Linewidth',2);
...
%     figure(5)
%     scatter3(initial_landmarks(1,:),initial_landmarks(2,:),initial_landmarks(3,:), 20,'filled');
%     hold on
%     plot3(T_C2_W(1),T_C2_W(2),T_C2_W(3),'rx');
%     axis equal;
%     axis vis3d;
%     grid off;
%     xlabel('X');
